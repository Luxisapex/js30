...
const inventorTotalYears = inventors.reduce((total, inventor) => total + inventor.passed-inventor.year, 0);
console.log(inventorTotalYears);

// 5. Sort the inventors by years lived
const sortedYearsInventors = inventors.sort((i1, i2) => i1.passed-i1.year > i2.passed-i2.year ? 1 : -1);
console.table(sortedYearsInventors);
...
const sortedNames = people.sort((lastPerson, nextPerson) => {
  [aLast, aFirst] = lastPerson.split(', ');
  [bLast, bFirst] = nextPerson.split(', ');
